...
Store your favorite or high-traffic directories in `~/.config/larbs/bmdirs` or your most
important config files in `~/.config/larbs/bmfiles` with keyboard shortcuts. When you add
